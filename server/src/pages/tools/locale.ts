...
export const requestError = Object.freeze({
  ...
  emailVerificationLocked: {
    en: 'Too many failed email verification attempts. Please try again after 30 minutes.',
    fr: 'Trop de tentatives échouées de vérification par email. Veuillez réessayer dans 30 minutes.',
    zh: '邮箱验证失败次数过多。请在 30 分钟后重试。',
  },
  passwordlessLocked: {
