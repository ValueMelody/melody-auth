export enum ConfigError {
  ...
  RecoveryCodeNotEnabled = 'Recovery code is not enabled',
...
export enum RequestError {
  ...
  InvalidSamlInResponseTo = 'SAML response InResponseTo does not match the authentication request',
  ...
  RecoveryCodeAlreadySet = 'Recovery code already set',
  ...
  EmailVerificationLocked = 'Too many failed email verification attempts. Please try again after 30 minutes.',
