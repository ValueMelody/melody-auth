import{_ as n,c as s,a,o as t}from"./app-CcTSijay.js";const d={};function i(l,e){return t(),s("div",null,e[0]||(e[0]=[a(`<h1 id="web-sdk" tabindex="-1"><a class="header-anchor" href="#web-sdk"><span>Web SDK</span></a></h1><p>Web SDK 可让你将 Melody Auth 集成到使用原生 JavaScript 的 Web 应用程序中。</p><h2 id="安装" tabindex="-1"><a class="header-anchor" href="#安装"><span>安装</span></a></h2><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">npm install @melody-auth/web --save</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div></div></div><h2 id="配置" tabindex="-1"><a class="header-anchor" href="#配置"><span>配置</span></a></h2><p>Web SDK 的函数接受一个共享的配置对象。</p><table><thead><tr><th>参数</th><th>类型</th><th>描述</th><th>默认值</th><th>必填</th></tr></thead><tbody><tr><td>clientId</td><td>string</td><td>前端连接的认证 clientId</td><td>N/A</td><td>是</td></tr><tr><td>redirectUri</td><td>string</td><td>用户成功认证后重定向的 URL</td><td>N/A</td><td>是</td></tr><tr><td>serverUri</td><td>string</td><td>你托管 melody auth 服务器的 URL</td><td>N/A</td><td>是</td></tr><tr><td>scopes</td><td>string[]</td><td>请求用户访问权限的范围</td><td>N/A</td><td>否</td></tr><tr><td>storage</td><td>&#39;sessionStorage&#39; | &#39;localStorage&#39;</td><td>存储认证 token 的类型</td><td>&#39;localStorage&#39;</td><td>否</td></tr></tbody></table><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">import {</span>
...
<span class="line">}</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="loginredirect" tabindex="-1"><a class="header-anchor" href="#loginredirect"><span>loginRedirect</span></a></h2><p>通过重定向到认证服务器启动一个新的认证流程。</p><table><thead><tr><th>参数</th><th>类型</th><th>描述</th><th>默认值</th><th>必填</th></tr></thead><tbody><tr><td>locale</td><td>string</td><td>指定认证流程中使用的语言环境</td><td>N/A</td><td>否</td></tr><tr><td>state</td><td>string</td><td>指定认证流程中使用的 state，如果不想使用随机生成的字符串</td><td>N/A</td><td>否</td></tr><tr><td>policy</td><td>string</td><td>指定认证流程中使用的策略</td><td>&#39;sign_in_or_sign_up&#39;</td><td>否</td></tr><tr><td>org</td><td>string</td><td>指定认证流程中使用的组织，值应为组织的 slug</td><td>N/A</td><td>否</td></tr></tbody></table><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">await triggerLogin(&#39;redirect&#39;, config, {</span>
...
<span class="line">)</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="acquireuserinfo" tabindex="-1"><a class="header-anchor" href="#acquireuserinfo"><span>acquireUserInfo</span></a></h2><p>使用有效的 access token 从认证服务器获取用户的公开信息。</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">const userInfo = await getUserInfo(config, { accessToken })</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div></div></div><h2 id="logoutredirect" tabindex="-1"><a class="header-anchor" href="#logoutredirect"><span>logoutRedirect</span></a></h2><p>注销用户。当 <code>localOnly</code> 为 false 且存在 refresh token 时，会先发送远程注销请求以获取注销后的重定向地址。然后清除本地 token 并重定向浏览器。</p><table><thead><tr><th>参数</th><th>类型</th><th>描述</th></tr></thead><tbody><tr><td>postLogoutRedirectUri</td><td>string</td><td>用户注销后重定向的 URL</td></tr><tr><td>localOnly</td><td>boolean</td><td>如果为 true，则只清除本地 token 并重定向，不进行远程注销</td></tr></tbody></table><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">import { getStorage, StorageKey } from &#39;@melody-auth/shared&#39;</span>
<span class="line"></span>
<span class="line">const storage = getStorage(config.storage)</span>
