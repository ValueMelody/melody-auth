...
<span class="line">}</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="loginredirect" tabindex="-1"><a class="header-anchor" href="#loginredirect"><span>loginRedirect</span></a></h2><p>Triggers a new authentication flow by redirecting to the auth server.</p><table><thead><tr><th>Parameter</th><th>Type</th><th>Description</th><th>Default</th><th>Required</th></tr></thead><tbody><tr><td>locale</td><td>string</td><td>Specifies the locale to use in the authentication flow</td><td>N/A</td><td>No</td></tr><tr><td>state</td><td>string</td><td>Specifies the state to use in the authentication flow if you prefer not to use a randomly generated string</td><td>N/A</td><td>No</td></tr><tr><td>policy</td><td>string</td><td>Specifies the policy to use in the authentication flow</td><td>&#39;sign_in_or_sign_up&#39;</td><td>No</td></tr><tr><td>org</td><td>string</td><td>Specifies the organization to use in the authentication flow</td><td>N/A</td><td>No</td></tr></tbody></table><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">import { useAuth } from &#39;@melody-auth/react&#39;</span>
<span class="line"></span>
<span class="line">export default function Home () {</span>
...
<span class="line">  }</span>
<span class="line">}</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="loginpopup" tabindex="-1"><a class="header-anchor" href="#loginpopup"><span>loginPopup</span></a></h2><p>Triggers a new authentication flow in a popup.</p><table><thead><tr><th>Parameter</th><th>Type</th><th>Description</th><th>Default</th><th>Required</th></tr></thead><tbody><tr><td>locale</td><td>string</td><td>Specifies the locale to use in the authentication flow</td><td>N/A</td><td>No</td></tr><tr><td>state</td><td>string</td><td>Specifies the state to use in the authentication flow if you prefer not to use a randomly generated string</td><td>N/A</td><td>No</td></tr><tr><td>org</td><td>string</td><td>Specifies the organization to use in the authentication flow</td><td>N/A</td><td>No</td></tr></tbody></table><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">import { useAuth } from &#39;@melody-auth/react&#39;</span>
<span class="line"></span>
<span class="line">export default function Home () {</span>
...
<span class="line">}</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,58)]))}const c=n(t,[["render",l],["__file","react-sdk.html.vue"]]),o=JSON.parse('{"path":"/react-sdk.html","title":"React SDK","lang":"en-US","frontmatter":{},"headers":[{"level":2,"title":"Installation","slug":"installation","link":"#installation","children":[]},{"level":2,"title":"AuthProvider","slug":"authprovider","link":"#authprovider","children":[]},{"level":2,"title":"isAuthenticated","slug":"isauthenticated","link":"#isauthenticated","children":[]},{"level":2,"title":"loginRedirect","slug":"loginredirect","link":"#loginredirect","children":[]},{"level":2,"title":"loginPopup","slug":"loginpopup","link":"#loginpopup","children":[]},{"level":2,"title":"logoutRedirect","slug":"logoutredirect","link":"#logoutredirect","children":[]},{"level":2,"title":"acquireToken","slug":"acquiretoken","link":"#acquiretoken","children":[]},{"level":2,"title":"acquireUserInfo","slug":"acquireuserinfo","link":"#acquireuserinfo","children":[]},{"level":2,"title":"userInfo","slug":"userinfo","link":"#userinfo","children":[]},{"level":2,"title":"isAuthenticating","slug":"isauthenticating","link":"#isauthenticating","children":[]},{"level":2,"title":"isLoadingToken","slug":"isloadingtoken","link":"#isloadingtoken","children":[]},{"level":2,"title":"isLoadingUserInfo","slug":"isloadinguserinfo","link":"#isloadinguserinfo","children":[]},{"level":2,"title":"authenticationError","slug":"authenticationerror","link":"#authenticationerror","children":[]},{"level":2,"title":"acquireTokenError","slug":"acquiretokenerror","link":"#acquiretokenerror","children":[]},{"level":2,"title":"acquireUserInfoError","slug":"acquireuserinfoerror","link":"#acquireuserinfoerror","children":[]},{"level":2,"title":"account","slug":"account","link":"#account","children":[]},{"level":2,"title":"loginError","slug":"loginerror","link":"#loginerror","children":[]},{"level":2,"title":"logoutError","slug":"logouterror","link":"#logouterror","children":[]}],"git":{"updatedTime":1742010392000,"contributors":[{"name":"Baozier","username":"Baozier","email":"byn9826@gmail.com","commits":12,"url":"https://github.com/Baozier"}],"changelog":[{"hash":"a5d2ea53baf6745787853bdf5c8a83c4b68cd248","date":1742010392000,"email":"byn9826@gmail.com","author":"Baozier","message":"Exposure userInfo directly from react-sdk and use in admin-panel (#266)"},{"hash":"dfab4ec2f967fd41a982ec46405efe2f0604329e","date":1741821787000,"email":"byn9826@gmail.com","author":"Baozier","message":"Add vue sdk package @melody-auth/vue (#260)"},{"hash":"dcc7904d45937761251f8fe19254c40c61c15711","date":1739930974000,"email":"byn9826@gmail.com","author":"Baozier","message":"Support login with popup in react-sdk (#233)"},{"hash":"2cffc8969ef12e367cb0caa78e545107191f80d7","date":1730941938000,"email":"byn9826@gmail.com","author":"Baozier","message":"Add docs for how to trigger a policy (#189)","tag":"v1.1.0"},{"hash":"84e6126d4d32fc04825dc55dd506e5a1a09e2ab5","date":1726794251000,"email":"byn9826@gmail.com","author":"Baozier","message":"Allow set and load state during login redirect (#163)"},{"hash":"155079ce08bb29f776a1cac7bd21e984f8ba88c5","date":1723405770000,"email":"byn9826@gmail.com","author":"Baozier","message":"Decode id_token as account in react sdk (#95)"},{"hash":"5804351a18bc976430f49e83543ec0a9eea480a6","date":1723336999000,"email":"byn9826@gmail.com","author":"Baozier","message":"Full locale support for identity pages and emails (#85)"},{"hash":"d265a44f90805217c6ec87dc91039de176ef8813","date":1723065969000,"email":"byn9826@gmail.com","author":"Baozier","message":"Default refresh token storage to localStorage (#79)"},{"hash":"e382551b92e0befd63ebfd7589710ceb5746c342","date":1722648544000,"email":"byn9826@gmail.com","author":"Baozier","message":"Add loading effect when manage resources in admin panel (#64)"},{"hash":"300dcd66ab1f55330473a42d3e830126b75a3fc7","date":1722545376000,"email":"byn9826@gmail.com","author":"Baozier","message":"Export more loading and error state from react-sdk (#61)"},{"hash":"7a3a2e2e84aa4f2e5d66c7b0f4830abb4ed9a72b","date":1722476406000,"email":"byn9826@gmail.com","author":"Baozier","message":"Exposure isLoading state when react sdk is fetching user info (#59)"},{"hash":"c667eebfc475caf5e63d9676f6201d086086fd97","date":1721333760000,"email":"byn9826@gmail.com","author":"Baozier","message":"Add doc for react-sdk (#24)"}]},"filePathRelative":"react-sdk.md"}');export{c as comp,o as data};
